...
public:
   DepthwiseConv2D<int16_t> l49; // fused_gemm_0, output_exponent: -10
    ...
    MNIST() :
        ...
        l41(DepthwiseConv2D<int16_t>(-9, get_model_2_depthwise_conv2d_45_depthwise_filter(), get_model_2_depthwise_conv2d_45_depthwise_bias(), get_model_2_depthwise_conv2d_45_depthwise_activation(), PADDING_SAME_END, {1,1,1,1}, 1,1)),
        l42(Conv2D<int16_t>(-9, get_model_2_conv2d_95_conv2d_filter(), get_model_2_conv2d_95_conv2d_bias(), NULL, PADDING_SAME_END, {0,0,0,0}, 1,1)),
        
        l43(Add2D<int16_t>(-9, NULL)),

        l44(Conv2D<int16_t>(-10, get_model_2_conv2d_96_conv2d_filter(), get_model_2_conv2d_96_conv2d_bias(), get_model_2_conv2d_96_conv2d_activation(), PADDING_SAME_END, {0,0,0,0}, 1,1)),
        l45(DepthwiseConv2D<int16_t>(-9, get_model_2_depthwise_conv2d_46_depthwise_filter(), get_model_2_depthwise_conv2d_46_depthwise_bias(), get_model_2_depthwise_conv2d_46_depthwise_activation(), PADDING_SAME_END, {1,1,1,1}, 1,1)),
        l46(Conv2D<int16_t>(-9, get_model_2_conv2d_97_conv2d_filter(), get_model_2_conv2d_97_conv2d_bias(), NULL ,PADDING_SAME_END, {0,0,0,0}, 1,1)),

        l47(Add2D<int16_t>(-8, NULL)),
        
        l48(Conv2D<int16_t>(-9, get_model_2_conv2d_98_conv2d_filter(), get_model_2_conv2d_98_conv2d_bias(), get_model_2_conv2d_98_conv2d_activation(), PADDING_SAME_END, {0,0,0,0}, 1,1)),
        l49(DepthwiseConv2D<int16_t>(-9, get_model_2_depthwise_conv2d_47_depthwise_filter(), get_model_2_depthwise_conv2d_47_depthwise_bias(), get_model_2_depthwise_conv2d_47_depthwise_activation(),PADDING_SAME_END, {0,0,1,1}, 2,2)) {}
...
//CHange
    ...
    this->l43.build(this->l42.get_output(), this->l39.get_output());
...
void call(Tensor<int16_t> &input)
{
    ...
    this->l43.call(this->l42.get_output(), this->l39.get_output());
    this->l39.get_output().free_element();
