...
public:
    ...
    MNIST() :
        ...
        l24(Conv2D<int16_t>(-11, get_model_2_conv2d_85_conv2d_filter(), get_model_2_conv2d_85_conv2d_bias(), NULL ,PADDING_SAME_END, {0,0,0,0}, 1,1)),
        l25(Conv2D<int16_t>(-10, get_model_2_conv2d_86_conv2d_filter(), get_model_2_conv2d_86_conv2d_bias(), get_model_2_conv2d_86_conv2d_activation(), PADDING_SAME_END, {0,0,0,0}, 1,1)),
        l26(DepthwiseConv2D<int16_t>(-10, get_model_2_depthwise_conv2d_41_depthwise_filter(), get_model_2_depthwise_conv2d_41_depthwise_bias(), get_model_2_depthwise_conv2d_41_depthwise_activation(), PADDING_SAME_END, {1,1,1,1}, 1,1)),
        l27(Conv2D<int16_t>(-10, get_model_2_conv2d_87_conv2d_filter(), get_model_2_conv2d_87_conv2d_bias(), NULL,PADDING_SAME_END, {0,0,0,0}, 1,1)),

        l28(Add2D<int16_t>(-10, NULL)),

        l29(Conv2D<int16_t>(-10, get_model_2_conv2d_88_conv2d_filter(), get_model_2_conv2d_88_conv2d_bias(), get_model_2_conv2d_88_conv2d_activation(), PADDING_SAME_END, {0,0,0,0}, 1,1)),
        l30(DepthwiseConv2D<int16_t>(-10, get_model_2_depthwise_conv2d_42_depthwise_filter(), get_model_2_depthwise_conv2d_42_depthwise_bias(), get_model_2_depthwise_conv2d_42_depthwise_activation(), PADDING_SAME_END, {1,1,1,1}, 1,1)),
        l31(Conv2D<int16_t>(-10, get_model_2_conv2d_89_conv2d_filter(), get_model_2_conv2d_89_conv2d_bias(), NULL,PADDING_SAME_END, {0,0,0,0}, 1,1)),

        l32(Add2D<int16_t>(-9, NULL)),

        l33(Conv2D<int16_t>(-10, get_model_2_conv2d_90_conv2d_filter(), get_model_2_conv2d_90_conv2d_bias(), get_model_2_conv2d_90_conv2d_activation(), PADDING_SAME_END, {0,0,0,0}, 1,1)),
        l34(DepthwiseConv2D<int16_t>(-9, get_model_2_depthwise_conv2d_43_depthwise_filter(), get_model_2_depthwise_conv2d_43_depthwise_bias(), get_model_2_depthwise_conv2d_43_depthwise_activation(), PADDING_SAME_END, {1,1,1,1}, 1,1)),
        l35(Conv2D<int16_t>(-9, get_model_2_conv2d_91_conv2d_filter(), get_model_2_conv2d_91_conv2d_bias(), NULL ,PADDING_SAME_END, {0,0,0,0}, 1,1)),
        ...
        // l55(Conv2D<int16_t>(-9, get_model_2_conv2d_102_conv2d_filter(), get_model_2_conv2d_102_conv2d_bias(), get_model_2_conv2d_102_conv2d_activation())),
        // l56(DepthwiseConv2D<int16_t>(-9, get_model_2_depthwise_conv2d_49_depthwise_filter(), get_model_2_depthwise_conv2d_49_depthwise_bias(), get_model_2_depthwise_conv2d_49_depthwise_activation())),
        // l57(Conv2D<int16_t>(-9, get_model_2_conv2d_103_conv2d_filter(), get_model_2_conv2d_103_conv2d_bias())),

        // l58(Add2D<int16_t>(-8, NULL)),

        // l59(Conv2D<int16_t>(-9, get_model_2_conv2d_104_conv2d_filter(), get_model_2_conv2d_104_conv2d_bias(), get_model_2_conv2d_104_conv2d_activation())),
        // l60(DepthwiseConv2D<int16_t>(-8, get_model_2_depthwise_conv2d_50_depthwise_filter(), get_model_2_depthwise_conv2d_50_depthwise_bias(), get_model_2_depthwise_conv2d_50_depthwise_activation())),
        // l61(Conv2D<int16_t>(-8, get_model_2_conv2d_105_conv2d_filter(), get_model_2_conv2d_105_conv2d_bias())),
        // l62(Conv2D<int16_t>(-8, get_model_2_conv2d_106_conv2d_filter(), get_model_2_conv2d_106_conv2d_bias(), get_model_2_conv2d_106_conv2d_activation())),

        // l63(GlobalAveragePool2D<int16_t>(-8)),  // GlobalAveragePool
        // l64(Squeeze<int16_t>(2)),  // Squeeze
        // l65(Conv2D<int16_t>(-9, get_model_2_conv2d_107_biasadd_filter(), get_model_2_conv2d_107_biasadd_bias())),
